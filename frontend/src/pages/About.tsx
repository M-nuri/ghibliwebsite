      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <motion.div className="max-w-3xl mx-auto text-center" initial="hidden" animate="visible" variants={fadeInUp}>
            ...
            <p className="text-xl text-white/70 max-w-2xl mx-auto">{language === 'ar' ? 'التنفيذ المحلي. المعايير الدولية.' : 'Local Execution. International Standards.'}</p>
          </motion.div>
        </div>
      </section>
              ...
              <motion.div key="about" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.3 }} className="max-w-6xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                  <div>
                    ...
                    <p className="text-neutral-600 dark:text-neutral-400 text-lg leading-relaxed mb-6">{language === 'ar' ? 'شركة جيبلي للطاقة هي شركة خدمات مقرها ليبيا، تقدم خدمات دعم متكاملة للمواقع والمرافق في قطاع التنقيب والإنتاج، ومرافق الإنتاج المبكر، والمحطات، ووحدات التكرير والتصنيع. نوفر فرقًا متعددة التخصصات لضمان سلامة المنشآت وصيانتها وتصنيعها وحمايتها من التآكل، بالإضافة إلى دعم البنية التحتية للمواقع.' : 'Ghibli Energy is a Libya-based services company delivering integrated field and facility support across upstream assets, early production facilities, terminals, and downstream plants. We mobilise multidisciplinary teams for integrity, maintenance, fabrication, corrosion protection, and site infrastructure.'}</p>
                    <p className="text-neutral-600 dark:text-neutral-400 text-lg leading-relaxed">{language === 'ar' ? 'نحن ملتزمون بأنعمل كمقاول رئيسي مسؤول عن التسليم، أو كمقاول فرعي متخصص يدعم حزم العمل المحددة. يتم تنفيذ كل نطاق عمل مع الالتزام التام بمعايير الصحة والسلامة والبيئة، وضمان الجودة، والتوثيق، وإغلاق المشروع بأدلة قابلة للتدقيق، دون ترك أي ثغرات.' : 'We operate as a prime contractor accountable for delivery, or as a specialist subcontractor supporting defined work packages. Every scope is executed with controlled HSE, QA/QC, and documentation - closed out with auditable evidence, not loose ends.'}</p>
                    <p className="text-neutral-600 dark:text-neutral-400 text-lg leading-relaxed">{language === 'ar' ? 'كما نوفر أيضًا قدرات التوريد والخدمات اللوجستية ودعم المواقع اللازمة للتنفيذ الموثوق في ليبيا - بما في ذلك التنسيق الجمركي والمخيمات المعيارية والإقامة وإدارة الغازات الصناعية.' : 'We also provide procurement, logistics, and site-support capabilities required to execute reliably in Libya - including customs coordination, modular camps, accommodation, and industrial gas management.'}</p>
              ...
              <motion.div key="mission" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.3 }} className="max-w-6xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="card-glass p-10 relative overflow-hidden group bg-white/80 dark:bg-neutral-900/80 backdrop-blur-sm">
                    ...
                    <p className="text-neutral-600 dark:text-neutral-400 text-lg leading-relaxed relative">{language === 'ar' ? 'نُقدّم خدمات ميدانية وخدمات مرافق مُراقبة وموثّقة وآمنة في جميع أنحاء البنية التحتية للطاقة في ليبيا. هدفنا هو أن يُنجز عملاؤنا نطاقات العمل في الوقت المحدد، مع إغلاق نهائي سليم وسجلات قابلة للتدقيق، دون إعادة عمل أو قوائم ملاحظات مفتوحة..' : 'To  deliver controlled, documented, and safe execution of field and facility services across Libya\'s energy infrastructure. We exist so our clients get scopes completed on time, with clean close-out and auditable records, not rework and open punch lists.'}</p>
                  </div>
                  <div className="card-glass p-10 relative overflow-hidden group bg-white/80 dark:bg-neutral-900/80 backdrop-blur-sm">
                    ...
                    <p className="text-neutral-600 dark:text-neutral-400 text-lg leading-relaxed relative">{language === 'ar' ? ' أن نكون المقاول الأكثر ثقة في ليبيا في مجال خدمات الطاقة، والمعروف بجودة التنفيذ، والالتزام بالتوثيق، والقدرة على التعبئة السريعة في مجالات السلامة والصيانة والإغلاق والمشتريات والبنية التحتية للموقع.' : 'To be Libya\'s most trusted energy services contractor, recognised for execution quality, documentation discipline, and the ability to mobilise fast across integrity, maintenance, shutdowns, procurement, and site infrastructure scopes.'}</p>
                  </div>
                </div>
              </motion.div>
            )}
